...
import ${package}.${moduleName}.service.WmsPurchaseService;
 ...
 */
@RestController
@RequestMapping("${moduleName}/wmspurchase")
public class WmsPurchaseController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("${moduleName}:wmspurchase:list")
    ...
    //@RequiresPermissions("${moduleName}:wmspurchase:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("${moduleName}:wmspurchase:save")
    ...
    //@RequiresPermissions("${moduleName}:wmspurchase:update")
    ...
    //@RequiresPermissions("${moduleName}:wmspurchase:delete")
