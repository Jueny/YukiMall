 ...
 */
@RestController
@RequestMapping("${moduleName}/wmswareordertaskdetail")
public class WmsWareOrderTaskDetailController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("${moduleName}:wmswareordertaskdetail:list")
    ...
    //@RequiresPermissions("${moduleName}:wmswareordertaskdetail:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("${moduleName}:wmswareordertaskdetail:save")
    ...
    //@RequiresPermissions("${moduleName}:wmswareordertaskdetail:update")
    ...
    //@RequiresPermissions("${moduleName}:wmswareordertaskdetail:delete")
